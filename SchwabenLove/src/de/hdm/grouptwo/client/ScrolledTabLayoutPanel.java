 ...
 * 
 * @author matfsw@gmail.com, Thomas Dall'Agnese, JeromeBadt
 */
public class ScrolledTabLayoutPanel extends TabLayoutPanel {
	...
	public void add(Widget child, String text) {
		super.insert(child, text, getWidgetCount());
		checkIfScrollButtonsNecessary();
	}
	...
	public void add(Widget child, String text, boolean asHtml) {
		super.insert(child, text, asHtml, getWidgetCount());
		checkIfScrollButtonsNecessary();
	}
	...
	private void initScrollButtons() {
		...
		scrollLeftButton.setStyleDependentName("ScrollButton", true);
		...
		scrollRightButton.setStyleDependentName("ScrollButton", true);

...
public class ImprintPage extends ContentPage {
	...
	/*
	 * (non-Javadoc)
	 * @see de.hdm.grouptwo.client.ContentPage#updatePage()
	 */
	public void updatePage() {
		
		/*
		 * Create VerticalPanel and html objects for 
		 * the content
		 */
		...
		html6.setHTML("<br><strong>Google Analytics</strong><br><br>"
				...
				+ "beschriebenen Art und Weise und zu dem zuvor benannten Zweck einverstanden.<br>");
		...
		/*
		 * Add all html objects to the VerticalPanel
		 * and set the fix width for the VerticalPanel
		 */
		vPanel.add(html1);	
		vPanel.add(html2);
		vPanel.add(html3);
